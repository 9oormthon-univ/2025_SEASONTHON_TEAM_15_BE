        ...
        http.cors(cors -> cors.disable())
            ...
            .authorizeHttpRequests(auth -> 
                auth.requestMatchers("/api/auth/register", "/api/auth/login", "/api/auth/logout").permitAll()
                    .requestMatchers("/api/auth/email", "/api/auth/account").authenticated()
                    .requestMatchers("/api/users/check-nickname", "/api/users/generations").permitAll()
                    .requestMatchers("/api/users/profile", "/api/users/password", "/api/users/account").authenticated()
